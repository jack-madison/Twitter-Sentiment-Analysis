...
week1 = pd.read_csv('./1_tweets_raw/2019/feb1_7.csv')
week2 = pd.read_csv('./1_tweets_raw/2019/feb8_14.csv')
week3 = pd.read_csv('./1_tweets_raw/2019/feb15_21.csv')
week4 = pd.read_csv('./1_tweets_raw/2019/feb22_28.csv')
...
month.to_csv('./1_tweets_raw/2019/02_2019.csv')