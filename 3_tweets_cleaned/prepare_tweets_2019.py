...
tweets_feb_w1 = tweets.loc[(tweets['tweet_created_at'] >= '2019-02-01') & (tweets['tweet_created_at'] < '2019-02-08')]
tweets_feb_w2 = tweets.loc[(tweets['tweet_created_at'] >= '2019-02-08') & (tweets['tweet_created_at'] < '2019-02-14')]
